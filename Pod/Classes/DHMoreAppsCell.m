...
- (void)initialSetup {
    ...
    _buttonAction = [[DHButtonCell alloc] init];
    ...
    _imageViewStar1 = [[DHStarView alloc] initWithFillMode:DHStarViewFillFull];
    _imageViewStar2 = [[DHStarView alloc] initWithFillMode:DHStarViewFillFull];
    _imageViewStar3 = [[DHStarView alloc] initWithFillMode:DHStarViewFillFull];
    _imageViewStar4 = [[DHStarView alloc] initWithFillMode:DHStarViewFillFull];
    _imageViewStar5 = [[DHStarView alloc] initWithFillMode:DHStarViewFillFull];
    
    NSArray *starsArray = @[_imageViewStar1, _imageViewStar2, _imageViewStar3, _imageViewStar4, _imageViewStar5];
    NSInteger count = 0;
    for (DHStarView *starView in starsArray) {
...
[_viewScreenshots addSubview:_imageViewScreenshotPortrait2];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(cellInterruptLoading:) name:@"DHMoreAppsInterruptLoadingKey" object:nil];
}

- (void)dealloc {
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"DHMoreAppsInterruptLoadingKey" object:nil];
}
...
- (void)buttonPressed:(UIButton *)button {
    if ([_delegate respondsToSelector:@selector(moreAppsCell:buttonPressed:)]) {
        dispatch_async(dispatch_get_main_queue(), ^{
            [self->_delegate moreAppsCell:self buttonPressed:button];
        });
    }
}
...
- (void)setNumberOfStars:(CGFloat)stars {
    ...
    if (stars == 1) {
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar3 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar4 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
    else if (stars == 1.5f) {
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillHalf];
        [_imageViewStar3 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar4 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
        ...
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillFull];
        [_imageViewStar3 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar4 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
        ...
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillFull];
        [_imageViewStar3 setFillMode:DHStarViewFillHalf];
        [_imageViewStar4 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
    else if (stars == 3) {
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillFull];
        [_imageViewStar3 setFillMode:DHStarViewFillFull];
        [_imageViewStar4 setFillMode:DHStarViewFillEmpty];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
    else if (stars == 3.5f) {
        ...
        [_imageViewStar2 setFillMode:DHStarViewFillFull];
        [_imageViewStar3 setFillMode:DHStarViewFillFull];
        [_imageViewStar4 setFillMode:DHStarViewFillHalf];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
    else if (stars == 4) {
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillFull];
        [_imageViewStar3 setFillMode:DHStarViewFillFull];
        [_imageViewStar4 setFillMode:DHStarViewFillFull];
        [_imageViewStar5 setFillMode:DHStarViewFillEmpty];
    }
    else if (stars == 4.5f) {
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        ...
        [_imageViewStar3 setFillMode:DHStarViewFillFull];
        [_imageViewStar4 setFillMode:DHStarViewFillFull];
        [_imageViewStar5 setFillMode:DHStarViewFillHalf];
    }
    else if (stars == 5) {
        [_imageViewStar1 setFillMode:DHStarViewFillFull];
        [_imageViewStar2 setFillMode:DHStarViewFillFull];
        [_imageViewStar3 setFillMode:DHStarViewFillFull];
        [_imageViewStar4 setFillMode:DHStarViewFillFull];
        [_imageViewStar5 setFillMode:DHStarViewFillFull];
    }
    else {
