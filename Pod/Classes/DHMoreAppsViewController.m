//
//  DHMoreAppsViewController.m
//  MoreApps
//

#import "DHMoreAppsViewController.h"
#import "DHMoreAppsCell.h"
...
@interface DHMoreAppsViewController () <UITableViewDataSource, UITableViewDelegate, SKStoreProductViewControllerDelegate, DHMoreAppsCellDelegate>
...
@property (nonatomic) DHDescriptionType descriptionType;
...
@implementation DHMoreAppsViewController
...
- (void)generateDatasource {
    ...
    if (_developerName) {
        ...
        url = [NSURL URLWithString:[NSString stringWithFormat:@"https://itunes.apple.com/lookup?bundleId=%@&entity=software&country=%@", string, [self getUserCountry]]];
    }
...
- (NSString *)getUserCountry {
    ...
    NSString *country = [[locale objectForKey: NSLocaleCountryCode] lowercaseString];
...
- (void)showStoreForAppId:(NSString *)appId {
    ...
    [parametersDict setObject:@"xxxxx" forKey:SKStoreProductParameterAffiliateToken];
...
- (void)buttonDonePressed:(UIBarButtonItem *)button {
    [[NSNotificationCenter defaultCenter] postNotificationName:@"DHMoreAppsInterruptLoadingKey" object:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    DHMoreAppsCell *cell = [tableView dequeueReusableCellWithIdentifier:@"AppCell"];
    if (!cell) {
        cell = [[DHMoreAppsCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"AppCell"];
    }
    ...
    BOOL horizontalSizeClassRegular = self.traitCollection.horizontalSizeClass == UIUserInterfaceSizeClassRegular;
    
    if (_descriptionType == DHDescriptionTypeNone || _descriptionType == DHDescriptionTypeText || (UIInterfaceOrientationIsLandscape([[UIApplication sharedApplication] statusBarOrientation]) && !horizontalSizeClassRegular)) {
        cell.selectionStyle = UITableViewCellSelectionStyleDefault;
        if (_descriptionType == DHDescriptionTypeText) {
    ...
    if (_showPrice) {
        ...
        NSURL *bundleURL = [[NSBundle mainBundle] URLForResource:@"DHMoreApps" withExtension:@"bundle"];
        ...
        NSString *buttonTitle = NSLocalizedStringFromTableInBundle(@"Get", @"DHMoreAppsLocalizable", bundle, nil);
    ...
    if (_descriptionType == DHDescriptionTypeScreenshots) {
...
#pragma mark - DHMoreAppsCellDelegate methods
...
- (void)handleSizeChange:(CGSize)size {
    if (size.width < size.height && _descriptionType == DHDescriptionTypeScreenshots) {
